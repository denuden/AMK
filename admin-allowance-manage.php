        ...
        <div class="pcoded-inner-content">
                ...
                <div class="page-wrapper">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex">
                            ...
                            class="btn btn-outline-success me-2" id="addAllowance">Add Allowance</button>
           ...
           ?>
            ...
            ?>
                                                        ...
                                                        <caption class="ps-2">Number of allowances:
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Allowance
                                                                    Details</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="number" class="form-control salary"
                                                                        placeholder="Salary per semi-monthly"
                                                                        aria-label="Salary">
                                                                </div>

                                                                <div class="input-group mb-3">
                                                                    <input type="number" class="form-control allowance"
                                                                        id="basic-url"
                                                                        placeholder="Allowance per semi-monthly"
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-primary"
                                                                    id="add">Add Allowance</button>
                                                                <button type="button" class="btn btn-primary"
                                                                    id="update">Update Allowance</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
