...
?>
  ...
  <body class="text-center">
    ...
    <main class="form-signin w-500 m-auto form">
    <form id="adminAjax"  class="md-float-material">

            <div class="auth-box">
            <div class="row m-b-20">
            <div class="col-md-12">
            <img class="mb-4 amklogo" src="images/logo.png" alt="" width="70">
            <h3 class="text-left txt-primary">Please sign in | Admin</h3>
                    </div>
                    </div>
              <hr/>
    ...
    <h1 class="h3 mb-3 fw-normal">Please sign in | Admin</h1> -->
               ...
               <div class="input-group">
                <input type="text" class="form-control usnA" id="floatingInput"    placeholder="Username" >          
                <span class="md-line"></span>
                </div>
                <div class="input-group">
                <input type="password" class="form-control pwdA" id="floatingPassword"  placeholder="Password" id="myInput" >
                <span class="md-line"></span>
                </div>

    <h5 id="error"></h5>
    <button class="w-100 btn btn-primary" type="submit">Sign in</button>
    <a href="employee-login" class="w-100 btn mt-1  btn-outline-info" type="button">Employee</a>
