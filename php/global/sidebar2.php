            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="/AMK/employee-panel.php">AMK Digital Payroll</a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li>
                                <a>
                                    <span style="margin-right: 330px">Amk Variety Store</span>
                                </a>
                            </li>
                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <?php if ($curPageName == "employee-panel.php"){ ?>
                            <li class="active">
                                <?php } else { ?>
                            <li>
                                <?php } ?>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <?php if ($curPageName == "employee-panel-request-status.php"){ ?>
                            <li class="active">
                                <?php } else { ?>
                            <li>
                                <?php } ?>
                                ...
                                <a href="/AMK/employee-panel-request-status" class="nav-link link-dark"
                                    aria-current="page">
